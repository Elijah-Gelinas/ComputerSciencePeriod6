...
RIGHT_IMAGE= pygame.image.load(os.path.join('Paddle.png'))
RIGHT = pygame.transform.scale(RIGHT_IMAGE, (PADDLE_WIDTH, PADDLE_HEIGHT))

LEFT_IMAGE = pygame.image.load(os.path.join('Paddle.png'))
LEFT = pygame.transform.scale(LEFT_IMAGE, (PADDLE_WIDTH, PADDLE_HEIGHT))

BALL_IMAGE = pygame.image.load(os.path.join('RedBall.png'))
BALL = pygame.transform.scale(BALL_IMAGE, (BALL_DIMENSION, BALL_DIMENSION))
ballcanMove = True
WAIT_TIME = 30

BG_IMAGE = pygame.image.load(os.path.join('Background.jpg'))
